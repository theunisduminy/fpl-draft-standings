...
profiles. Sign-in is Neon Auth with Google, restricted to the members listed in the
`league_members` table — seed it with `pnpm db:seed:members` (see
[`league-members.example.json`](./league-members.example.json)).
